...
function Job_Search_get_max( $array ) {

	return Job_Search_Globals::get_max( $array );
 ...
 */
function Job_Search_get_template( $name ) {

	return Job_Search_Globals::get_template( $name );

}

class Job_Search_Globals {
	 ...
	 */
 	public static function get_template( $name ) {
		 ...
		 */
		apply_filters( 'job-search-template-paths', $locations );
