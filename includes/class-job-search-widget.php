...
class Job_Search_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$name 					= esc_html__( 'Now Hiring', 'job-search' );
		$opts['classname'] 		= '';
		$opts['description'] 	= esc_html__( 'Display job postings on a sidebar', 'job-search' );
