<?php
class Job_Search_Admin_Metaboxes {
	...
	public function add_metaboxes() {
		...
		add_meta_box(
			'Job_Search_job_additional_info',
			apply_filters( $this->plugin_name . '-metabox-title-additional-info', esc_html__( 'Additional Info', 'job-search' ) ),
			array( $this, 'metabox' ),
			'job',
			'normal',
			'default',
		...
		add_meta_box(
			'Job_Search_job_requirements',
			apply_filters( $this->plugin_name . '-metabox-title-requirements', esc_html__( 'Job Requirements', 'job-search' ) ),
			array( $this, 'metabox' ),
			'job',
			'normal',
			'default',
		...
		add_meta_box(
			'Job_Search_job_files',
			apply_filters( $this->plugin_name . '-metabox-title-requirements', esc_html__( 'Related Files', 'job-search' ) ),
			array( $this, 'metabox' ),
			'job',
			'side',
			'default',
	...
	public function metabox( $post, $params ) {
		...
		include( plugin_dir_path( __FILE__ ) . 'partials/job-search-admin-metabox-' . $params['args']['file'] . '.php' );
	...
	public function save_files_order() {
		...
		check_ajax_referer( 'job-search-file-order-nonce', 'fileordernonce' );
		...
		esc_html_e( 'File order saved.', 'job-search' );
